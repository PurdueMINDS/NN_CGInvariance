...
def findAllSubspaces(listV, listT, powerSetMethod=None, method=2, decimals=6, debug=False):
    ...
    for configs in indexPowerSetConfigs:
        ...
        # This is used during projectAndRemove phase for the lower level subspaces later.
...
if __name__ == '__main__':
    ...
    if inputType == "sequence":
        ...
        listT, allSubspaces, powerSetConfigs = getAllBasis(folder=basisDir, listT=listT, Wshape=Wshape, force=False)
